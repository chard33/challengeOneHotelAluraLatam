...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		btnexit.setBackground(Color.RED/*new Color(12, 138, 199)*/);
		...
		txtNombre.addKeyListener(new KeyAdapter() {
			public void keyReleased(KeyEvent e) {
				StringBuilder txt = new StringBuilder(txtNombre.getText());
				if (!(Pattern.matches("^[a-z A-Z]+$", txtNombre.getText()))) {
					getToolkit().beep();
					JOptionPane.showMessageDialog(null, "Ingrese solo caracteres");
					txtNombre.setText(String.valueOf(txt.deleteCharAt(txt.length()-1)));
				}
			}
		});
		...
		txtApellido.addKeyListener(new KeyAdapter() {
			public void keyReleased(KeyEvent e) {
				StringBuilder txt = new StringBuilder(txtApellido.getText());
				if (!(Pattern.matches("^[a-z A-Z]+$", txtApellido.getText()))) {
					getToolkit().beep();
					JOptionPane.showMessageDialog(null, "Ingrese solo caracteres");
					txtApellido.setText(String.valueOf(txt.deleteCharAt(txt.length()-1)));
				}
			}
		});
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel(new String[] {"Selecciones " +
				"una opcion","afgano-afgana", "alemán-", "alemana", "árabe-árabe",
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(txtNombre.getText().isEmpty() ||
						...
						txtNacionalidad.getSelectedIndex() == 0 ||
					...
					controladorHues cH = new controladorHues();
					...
					if(JOptionPane.showConfirmDialog(null,
													 "Nombre: " + h.getNombre() + "\n" +
															 ...
															 "Fecha de nacimiento: " + new SimpleDateFormat("yyyy-MM-dd").format(h.getFechanacimineto()) + "\n" +
															 "Nacionalidad: " + h.getNacionalidad() + "\n" +
															 "Telefono: " + h.getTelefono() + "\n" +
															 "Numero de reserva: " + h.getIdreserva(),
	...
	public void obtenerNr(Long nReserva){
		
		txtNreserva.setText(String.valueOf(nReserva));
	}
